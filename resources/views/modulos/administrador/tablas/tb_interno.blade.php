@foreach ($query as $i => $q)
    <tr class="<?php if($q->urgente === 1 ){  echo "urgente";  } ?>">
        ...
        <td>
            <a href="{{ route('modulos.administrador.ver_interno', $q->id_folio) }}" class="bandejTool btn-cursor"  data-tippy-content="Ver Expediente" >
        ...
        <td class="inline">
            <a href="{{ route('modulos.administrador.edit_interno', $q->id_folio) }}" class="btn btn-sm nobtn"><i class="fa fa-pencil-square-o"></i>  Editar</a><br />
