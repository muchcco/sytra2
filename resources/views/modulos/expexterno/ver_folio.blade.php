...
var table_derivar = () => {
    ...
    $.ajax({
        type: 'GET',
        url: "{{ route('modulos.expexterno.tablas.tb_ver_derivar') }}" ,
        dataType: "json",
        data: {id:id},
...
var eliminarDerivados = (id) => {
    ...
    if(confirm("Desea Eliminar el Registro?")){
        $.ajax({
            url: "{{ route('modulos.expexterno.deletederivado') }}",
            type: 'post',
            dataType: 'html',
...
var btnEditDerivar = (id) => {
    ...
    $.ajax({
        type:'post',
        url: "{{ route('modulos.expexterno.modals.md_edit_derivar') }}",
        dataType: "json",
...
var btnModificarDerivar = (id) => {
    ...
    $.ajax({
            ...
            dataType: "json",
            cache: false,
            url: "{{ route('modulos.expexterno.edit_logderivar') }}",
            data: EditData,
            processData: false,
            contentType: false,
            success: function(data){
