...
var tabla = $("#table_recibido").DataTable();
var table_recibido = () => {
    $.ajax({
        type: 'GET',
        url: "{{ route('modulos.expexterno.tablas.tb_recibido') }}" ,
        dataType: "json",
        success: function(data){
            tabla.destroy();
            $("#table_recibido_body").html(data.html);
            tabla = $("#table_recibido").DataTable({
                "responsive": true,
                "autoWidth": false,
...
var btnDerivado = (id, prov, id_folio) => {
    console.log(prov);
    $.ajax({
        type:'post',
        url: "{{ route('modulos.expexterno.modals.md_rec_derivar') }}",
        dataType: "json",
        data:{"_token": "{{ csrf_token() }}", id : id, prov: prov, id_folio:id_folio},
        success:function(data){
            $("#modal_der_expediente").html(data.html);
            $("#modal_der_expediente").modal('show');
        }
    });
}
...
var btnModificarDerivar = (id) =>{
    ...
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        url: "{{ route('modulos.expexterno.rec_derivar') }}",
        data: formData,
        processData: false,
        contentType: false,
        success: function(data){
...
var btnArchivado = (id, prov, id_folio) => {
    ...
    $.ajax({
        type:'post',
        url: "{{ route('modulos.expexterno.modals.md_rec_archivar') }}",
        dataType: "json",
        data:{"_token": "{{ csrf_token() }}", id : id, prov: prov, id_folio:id_folio},
        success:function(data){
...
var btnModificarArchivar = (id) => {
    ...
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        url: "{{ route('modulos.expexterno.rec_archivar') }}",
        data: formData,
        processData: false,
        contentType: false,
        success: function(data){
                                ...
                                <div class="card-block">
                                    <div class="table">
                                        <div class="table-content">
                                            <table class="table table-bordered table-hover display compact nowrap" id="table_recibido">
                                                <thead class="bg-dark">
                                                    <tr >
                                                        <th></th>
